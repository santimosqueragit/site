        ...
        function navHighlight() {
            ...
            sections.forEach(function(current) {
                ...
                */
                ...
                // }
                if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
                    let sectionFound = document.querySelector('.s-header__nav a[href*=' + sectionId + ']')
                    if (sectionFound) sectionFound.parentNode.classList.add('current');
                } else {
                    let sectionFound = document.querySelector('.s-header__nav a[href*=' + sectionId + ']')
                    if (sectionFound) sectionFound.parentNode.classList.remove('current');
                }
            });
        }
